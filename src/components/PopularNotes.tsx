      ...
      try {
        ...
        const mockNotes = [
          ...
          },
          {
            ...
            description: 'Hücre yapısı ve organeller konuları',
            category: { _id: '4', name: 'Biyoloji', description: 'Biyoloji notları' },
            googleDriveUrl: 'https://drive.google.com/file/d/4example/view',
            downloadCount: 80,
            viewCount: 160,
            rating: 4.2,
            tags: ['hücre', 'biyoloji', '9. sınıf'],
            author: { name: 'Biyoloji Öğretmeni' },
            createdAt: new Date().toISOString()
          },
          {
            _id: '5',
            title: 'Türkçe - Dil Bilgisi',
            description: 'Dil bilgisi kuralları ve örnekler',
            category: { _id: '5', name: 'Türkçe', description: 'Türkçe notları' },
            googleDriveUrl: 'https://drive.google.com/file/d/5example/view',
            downloadCount: 70,
            viewCount: 140,
            rating: 4.0,
            tags: ['dil bilgisi', 'türkçe', '10. sınıf'],
            author: { name: 'Türkçe Öğretmeni' },
            createdAt: new Date().toISOString()
          },
          {
            _id: '6',
            title: 'Matematik - Geometri',
            description: 'Geometri konularında temel kavramlar',
            category: { _id: '1', name: 'Matematik', description: 'Matematik notları' },
            googleDriveUrl: 'https://drive.google.com/file/d/6example/view',
            downloadCount: 60,
            viewCount: 120,
            rating: 3.8,
            tags: ['geometri', 'matematik', '11. sınıf'],
            author: { name: 'Matematik Öğretmeni' },
            createdAt: new Date().toISOString()
          }
        ];
